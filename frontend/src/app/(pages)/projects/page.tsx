  ...
  return (
    <div className="p-6 flex flex-col gap-9">
      ...
      <div>
        ...
        {isOpen && (
          <ul className="mt-2 bg-white-200 rounded-lg shadow-md p-2">
            {projectNames.map((name, index) => (
              <li
                key={index}
                className="py-1 px-2 hover:bg-gray-100 rounded-lg"
              >
                {name}
              </li>
            ))}
          ...
          <tbody>
            {projects.map((project, index) => {
              ...
              return (
                ...
                >
                  <td className="relative py-5">{project.module}</td>
                  <td className="flex items-center gap- py-10">
                    <img
                      src={project.profilePicture}
                      alt={project.developer}
                      className="flex items-center w-6 h-6 rounded-full object-cover relative"
                    />
                    {project.developer}
                  </td>
