...
const Box: React.FC<BoxProps> = ({ icon, title, value, color }) => {
  ...
  return (
    <div className="flex gap-4 flex-wrap">
      <div className="bg-white-100 border shadow-lg bg-gradient-to-tl rounded-b-3xl rounded-t-3xl w-full h-46 p-6">
        <div
        ...
        <div className="mt-9">
          ...
          <h1 className="text-2xl text-black font-semibold mt-6">{value}</h1>
        </div>
      </div>
    </div>
  );
